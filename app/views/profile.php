...
$user = [
    ...
    "header_img" => "https://via.placeholder.com/800x200/0047AB/FFFFFF?text=NBA+Logo", 
];
    ...
    <div class="max-w-xl mx-auto border-x border-gray min-h-screen relative">
        ...
        <div class="sticky top-0 z-50 bg-white/80 backdrop-blur-md text-black h-14 w-full border-b border-gray">
            <div class="relative max-w-xl mx-auto flex items-center h-full px-4">
                ...
                <div class="absolute right-4">
                    <div class="cursor-pointer border border-black px-3 py-1 rounded text-[10px] uppercase font-bold hover:bg-black hover:text-white transition-all">
                        Login/Register
                    </div>
                </div>
            </div>
        ...
        <div class="relative">
            ...
            <div class="flex justify-end p-4">
                <button class="border border-black px-4 py-1 rounded-full font-bold text-xs hover:bg-gray-100 transition">Edit Profile</button>
            </div>
        </div>
        ...
        <div class="px-4 mt-12"> 
            ...
            <div class="flex gap-4 mt-3 text-sm">
                <span><strong class="text-black"><?php echo $user['following']; ?></strong> <span class="text-gray-500">Following</span></span>
                <span><strong class="text-black"><?php echo $user['followers']; ?></strong> <span class="text-gray-500">Followers</span></span>
            </div>
        </div>
