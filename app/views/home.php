    ...
    <div class="max-w-xl mx-auto border-x border-gray min-h-screen relative bg-white">
        ...
        <nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray h-14 flex items-center">
            ...
            <div class="flex-1 flex h-full">
                ...
                <a href="/profile" class="flex-1 flex items-center justify-center font-bold text-[11px] uppercase tracking-wider border-r border-gray text-gray-400 hover:text-black transition cursor-pointer">
                    Postingan saya
                </a>
            </div>
            <div class="px-4">
                <a href="/login" class="bg-black text-white text-[10px] font-bold px-3 py-1.5 rounded uppercase tracking-tight hover:bg-gray-800 transition">
                    Login/Register
                </a>
            </div>
        </nav>
        ...
        <div class="p-4 flex items-center gap-3 border-b border-gray">
            <img src="/assets/img/Foto Basket profile.png" class="w-10 h-10 rounded-full border border-gray object-cover shadow-sm">
        ...
        <div class="divide-y divide-gray">
            <?php 
            $posts = [
                ['img' => 'nba.png', 'content' => 'Orang paling ganteng'],
                ['img' => 'nba.png', 'content' => 'Orang paling ganteng'],
                ['img' => 'nba.png', 'content' => 'Orang paling ganteng']
            ];
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 rounded-2xl overflow-hidden border border-gray bg-gray-100">
                            <img src="/bakat-siswa/public/assets/img/<?php echo $post['img']; ?>" class="w-full aspect-[16/10] object-cover hover:scale-105 transition duration-500">
                        </div>
