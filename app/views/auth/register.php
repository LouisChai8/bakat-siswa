...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-4xl flex flex-col md:flex-row custom-rounded overflow-hidden shadow-2xl">
        ...
        <div class="flex-1 bg-black p-12 md:p-16 flex flex-col justify-center items-center text-center">
            ...
            <p class="text-gray-300 text-lg mb-12">Already have an account?</p>
            <a href="/login"
        ...
        <div class="flex-1 p-8 md:p-16 flex flex-col justify-center items-center">
            ...
            <h1 class="text-3xl md:text-4xl font-extrabold text-black mb-1">Welcome</h1>
            <p class="text-gray-400 font-medium mb-6">Create your account</p>
            ...
            <form action="/register" method="POST" class="w-full max-w-sm space-y-4">

                <!-- Name -->
                <div class="space-y-1">
                    <label class="block text-sm font-bold text-black ml-1">Full Name</label>
                    <div class="relative flex items-center border-2 border-[#d4c8c4] rounded-2xl p-3 input-focus transition-all">
                        <svg class="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                        </svg>
                        <input type="text" name="name" placeholder="Full Name"
                            value="<?php echo htmlspecialchars($old['name'] ?? ''); ?>"
                            class="w-full bg-transparent outline-none text-black placeholder-gray-400 font-medium text-sm" required>
                    </div>
                </div>

                <!-- Email -->
                <div class="space-y-1">
                    <label class="block text-sm font-bold text-black ml-1">Email</label>
                    <div class="relative flex items-center border-2 border-[#d4c8c4] rounded-2xl p-3 input-focus transition-all">
                        <svg class="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative flex items-center border-2 border-[#d4c8c4] rounded-2xl p-3 input-focus transition-all">
                        ...
                        <input type="text" name="username" placeholder="Username (max 15 chars)"
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative flex items-center border-2 border-[#d4c8c4] rounded-2xl p-3 input-focus transition-all">
                        ...
                        <input type="password" name="password" id="regPassword" placeholder="Min. 6 characters"
                            class="w-full bg-transparent outline-none text-black placeholder-gray-400 font-medium text-sm" required>
                        <button type="button" onclick="togglePassword('regPassword')" class="text-gray-400 ml-2">
                ...
                <!-- Confirm Password -->
                <div class="space-y-1">
                    <label class="block text-sm font-bold text-black ml-1">Confirm Password</label>
                    <div class="relative flex items-center border-2 border-[#d4c8c4] rounded-2xl p-3 input-focus transition-all">
                        <svg class="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                        <input type="password" name="confirm" id="regConfirm" placeholder="Repeat password"
                            class="w-full bg-transparent outline-none text-black placeholder-gray-400 font-medium text-sm" required>
                        <button type="button" onclick="togglePassword('regConfirm')" class="text-gray-400 ml-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
